...
function QAcard(person) {
  return (
      <tr key={person['ID']} className="border-b transition-colors border-[#ffffff21]  hover:bg-muted/50 data-[state=selected]:bg-muted">
          ...
          <td className="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
              <Link className="text-primary rounded-full border border-[#ffffff21] px-4 py-2" href={person['CV_LINK']}>
                  View Resume
              </Link>
          </td>
          <td className="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
