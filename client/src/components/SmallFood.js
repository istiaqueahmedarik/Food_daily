  ...
  return (
      <div className="grid grid-cols-2 space-y-1.5 p-6 border rounded-lg m-3 border-input  group">
          ...
          <div className='grid place-content-center'>
              <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight m-auto">{res.food[0]['NAME']}</h3>
              <p className="text-sm text-muted-foreground font-extralight">{res.food[0]['PRICE']}</p>
          </div>
      </div>
  )
}
