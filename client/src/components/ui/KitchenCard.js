...
function KitchenCard({ name = "Hungry", image = "/food.svg", address = "123, Food Street", edit = "",profile }) {
  ...
  return (
      <div className="relative w-[300px] h-[400px] rounded-xl overflow-hidden group border border-[#ffffff2d] ">
              ...
              />
      <div className="absolute opacity-0 group-hover:opacity-100 transition-all duration-700 top-4 right-4 z-20">
      ...
      <div className="absolute bottom-4 left-4 z-20">
        ...
        <Link href={`/chef/kitchen/${edit}`} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-[#ffffff2d] pl-5 pr-5 pt-2 pb-2 bg-transparent backdrop-blur-lg">
          Explore
