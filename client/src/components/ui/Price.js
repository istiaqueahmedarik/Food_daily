...
function Price(props) {
  return (
      <div className="flex items-center rounded-full border bg-white/70 p-1 text-xs font-semibold text-foreground backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white">
