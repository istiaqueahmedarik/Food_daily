...
function Feauture__card(props) {
  return (
    <div className='max-w-xs bg-[#161b22]  p-5 text-center m-auto border border-[#ffffff1a] rounded-xl'>
      <Image blurDataURL='/blur_food.png' placeholder='blur' sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"  quality={60} src={props.img} alt='Food plate' width={250} height={250} className='' />
