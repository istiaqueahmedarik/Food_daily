...
-- Drop all tables while maintaining integrity constraints

-- BEGIN
--     EXECUTE IMMEDIATE 'DROP TABLE MESSAGES CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE CONVERSATIONS CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE ACTIVE_DELIVERY CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE DELIVERY_COMMISION CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE DELIVERY_PARTNER CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE FOOD_RATING CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE REPORT_FOOD CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE LOGS CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE CHEF_COMMISION CASCADE CONSTRAINTS';
...
--     EXECUTE IMMEDIATE 'DROP TABLE KITCHEN_IMAGES CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE KITCHEN CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE CERTIFICATION CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE CHEF CASCADE CONSTRAINTS';
--     EXECUTE IMMEDIATE 'DROP TABLE QA_OFFICER CASCADE CONSTRAINTS';
...
-- drop all types
-- BEGIN
--     EXECUTE IMMEDIATE 'DROP TYPE FULL_NAME';
-- END;
-- /

-- drop all procedures
-- BEGIN
--     EXECUTE IMMEDIATE 'DROP PROCEDURE GET_ALL_USERS';
--     EXECUTE IMMEDIATE 'DROP FUNCTION GET_RATING_FOOD';
--     EXECUTE IMMEDIATE 'DROP FUNCTION GET_RATING_CATEGORY';
--     EXECUTE IMMEDIATE 'DROP FUNCTION GET_RATING_KITCHEN';
--     EXECUTE IMMEDIATE 'DROP FUNCTION GET_RATING_CHEF';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE ADD_REPORT_FOOD';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE REPORT_UNDER_REVIEW';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE REPORT_RESOLVED';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE BAN_CHEF';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE UNBAN_CHEF';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE MAKE_ADMIN';
--     EXECUTE IMMEDIATE 'DROP PROCEDURE REMOVE_ADMIN';
-- END;

-- drop all triggers
-- BEGIN
--     EXECUTE IMMEDIATE 'DROP TRIGGER REPORT_ID_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER LOGS_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER DELIVERY_COMMISION_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER CHEF_COMMISION_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER CONVERSATION_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER MESSAGE_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER FOOD_RATING_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER9';
--     EXECUTE IMMEDIATE 'DROP TRIGGER ACTIVE_DELIVERY_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER DELIVERY_PARTNER_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER CART_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER INGREDIENT_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER FOOD_TRIGGER';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER1';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER2';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER3';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER4';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER7';
--     EXECUTE IMMEDIATE 'DROP TRIGGER TRIGGER8';
-- END;

-- drop all sequences
-- BEGIN
--     EXECUTE IMMEDIATE 'DROP SEQUENCE REPORT_ID_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE LOGS_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE DELIVERY_COMMISION_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE CHEF_COMMISION_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE CONVERSATION_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE MESSAGE_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE FOOD_RATING_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE9';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE ACTIVE_DELIVERY_SEQ';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE DELIVERY_PARTNER_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE CART_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE INGREDIENT_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE FOOD_SEQUENCE';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE1';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE2';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE3';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE4';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE7';
--     EXECUTE IMMEDIATE 'DROP SEQUENCE SEQUENCE8';
-- END;