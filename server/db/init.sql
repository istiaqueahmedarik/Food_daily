...
CREATE OR REPLACE TRIGGER TRG_NOTIFY_MY_TABLE AFTER
    INSERT OR UPDATE ON FOOD_RATING FOR EACH ROW
BEGIN
    DBMS_ALERT.SIGNAL('FOOD_RATING', 'Table my_table was updated or inserted');
END;
/
