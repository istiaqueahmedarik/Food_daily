...
END;
/
CREATE OR REPLACE VIEW CHEF_NAME_VIEW("CHEF NAME")
AS
SELECT
    *
FROM
...
CREATE OR REPLACE VIEW CATEGORY_RATING_VIEW("CATEGORY ID","CATEGORY NAME","RATING")
AS
SELECT 
    C.ID,
    C.NAME,
    GET_RATING_CATEGORY(C.ID)
FROM 
    CATEGORY C

CREATE OR REPLACE VIEW KITCHEN_RATING_VIEW("ID","KITCHEN NAME","RATING")
AS
SELECT
    K.ID,
    K.NAME,
    GET_RATING_KITCHEN(K.ID)
FROM
    KITCHEN K 

CREATE OR REPLACE VIEW CHEF_RATING_VIEW("ID","CHEF NAME","RATING")
AS
SELECT
    C.ID,
    C.CHEF_NAME,
    GET_RATING_CHEF(C.ID)
FROM
    CHEF C

CREATE OR REPLACE VIEW FOOD_NAME_VIEW("ID","FOOD NAME")
AS
SELECT
    O.ID,
    GET_FOOD_NAMES(O.ID)
...
CREATE OR REPLACE VIEW KITCHEN_IMAGE_VIEW("KITCHEN ID","KITCHEN NAME","IMAGE")
AS
SELECT
    K.ID,
    K.NAME,
    GET_KITCHEN_IMAGE(K.ID)
FROM
    KITCHEN K
